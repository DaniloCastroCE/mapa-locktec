class Local {
  ...
  {
    nome: "BOSQUE DAS VIDEIRAS",
    nomeSimplificado: "bosque das videiras",
    lat: "-3.885804",
    lon: "-38.462167",
    ativo: true,
    tipo: "não definido",
  ...
  },
  {
    ...
    nomeSimplificado: "charles de gaulle",
    lat: "-3.740092",
    lon: "-38.492890",
    ativo: true,
    tipo: "portaria remota",
  ...
  {
    nome: "COMODORO (Em Implantação)",
    nomeSimplificado: "comodoro (em implantacao)",
    lat: "-3.731162",
    lon: "-38.461847",
    ativo: true,
    tipo: "não definido",
  ...
  {
    nome: "FERNANDES & MARTINS ADVOGADOS",
    nomeSimplificado: "fernandes & martins advogados",
    lat: "-3.734566",
    lon: "-38.485702",
    ativo: true,
    tipo: "alarme",
  ...
  {
    nome: "JARDIM DAS TULHERIAS",
    nomeSimplificado: "jardim das tulherias",
    lat: "-3.747750",
    lon: "-38.473069",
    ativo: true,
    tipo: "não definido",
  ...
  {
    nome: "LINDO PARQUE (Em Implantação)",
    nomeSimplificado: "lindo parque (em implantacao)",
    lat: "-3.753097",
    lon: "-38.503229",
    ativo: true,
    tipo: "não definido",
  ...
  {
    nome: "LUGANO (Em Implantação)",
    nomeSimplificado: "lugano (em implantacao)",
    lat: "-23.556844",
    lon: "-46.677508",
    ativo: true,
    tipo: "não definido",
  ...
  {
    nome: "PIAZZA NAVONA",
    nomeSimplificado: "piazza navona",
    lat: "-3.727011",
    lon: "-38.552650",
    ativo: true,
    tipo: "portaria remota",
  ...
  {
    nome: "SOLAR DAS MANGUEIRAS",
    nomeSimplificado: "solar das mangueiras",
    lat: "-22.938598",
    lon: "-43.194600",
    ativo: true,
    tipo: "não definido",
  ...
  {
    nome: "VARANDAS DO EUSÉBIO",
    nomeSimplificado: "varandas do eusebio",
    lat: "-3.885170",
    lon: "-38.466274",
    ativo: true,
    tipo: "não definido",
  ...
  async carregarLocaisApi() {
    try {
      const response = await fetch('https://mapa-locktec-old.vercel.app/get-condos/active')
      const result = await response.json()

      if (result.status === 'success' && result.condos) {
        this.locais = result.condos
